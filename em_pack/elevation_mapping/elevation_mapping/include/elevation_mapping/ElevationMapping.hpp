...
class ElevationMapping {
 ...
 protected:
  ...
  message_filters::Subscriber<geometry_msgs::PoseWithCovarianceStamped> robotPoseSubscriber_;     // message_filters下robot pose订阅句柄robotPoseSubscriber_
  ...
  message_filters::Cache<geometry_msgs::PoseWithCovarianceStamped> robotPoseCache_;                // message_filters下robot pose消息缓存句柄robotPoseCashe_
